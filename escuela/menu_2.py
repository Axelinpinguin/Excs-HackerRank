            ...
            if len(usuario)>=6 and len(usuario)<=10:
                for caracteres in usuario:
                    ...
                    if caracteres.isdigit():
                        numeros_usuario += 1
            if letras_usuario>0 and minusculas_usuario>0 and numeros_usuario>0 and usuario.isalnum()==True and mayusculas_usuario==0 and usuario[0].islower()==True and usuario[-1].isdigit()==True:
                    ...
                    if vecesQueAparece==0:
                        ...
                        while ingresardenuevo==True:
                            if contraseña[0].isupper()==True and contraseña[-1].isalnum()==False and espacio==0 :
                                ...
                                mas=True
                                while mas:
                                    otro=input('desea registrar otro usuario? (s/n): ')
                                    if otro=='s':
                                        mas=False
                ...
                print('usuario invalido... selecciona de nuevo la opcion a realizar..')
    elif opc =='i':
